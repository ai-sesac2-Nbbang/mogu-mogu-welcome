...
export default function Page() {
  const faqs = [
    {
      q: "모구 서비스는 뭐예요?",
      a: "동네 이웃과 함께 간편하게 공동구매하는 서비스에요. 모구장이 상품을 올리고, 모구러가 신청해서 정해진 스팟에서 수령해요.",
    },
    {
      q: "결제는 어떻게 해요?",
      a: "모구장이 먼저 결제하고, 추후 개인 송금으로 정산해요. 에스크로 및 플랫폼 내부 결제는 업데이트 예정이에요.",
    },
    {
      q: "환불은 가능해요?",
      a: "구매 확정 후에는 환불이 불가해요. 신선식품은 수령 후 2시간이 지나면 불량 신고가 어려워요. 판매금지 물품을 구매하거나 판매했을 경우에도 환불은 불가능해요",
    },
    {
      q: "노쇼(미통보 불참) 제재는 어떤 형식으로 이루어지나요?",
    ...
    <main className="mx-auto max-w-6xl px-4 py-8">
      ...
      <Reveal>
        <PageHeader
          eyebrow="도움말"
          title="자주 묻는 질문"
          description="빠르게 궁금증을 해결해요. 우측 문의 바로가기를 통해 구체적인 답변을 받을 수 있어요."
          actions={
            <a
              href="/support"
